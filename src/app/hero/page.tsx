      ...
      <section className="py-16 bg-[url('/banner.png')] bg-cover to-sky-900 text-teal-900 ">
        <div className="container mx-auto">
          ...
          <p className="text-lg  text-center max-w-3xl mx-auto font-extrabold">
            At <strong>Book Haven</strong>, our mission is to connect readers with the books
            they love. Whether you're exploring timeless classics, diving into thrilling
            adventures, or expanding your knowledge with non-fiction, we’re here to make your
            journey into the world of literature as smooth and enjoyable as possible.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-black to-sky-900 text-white">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gradient-to-r from-black to-sky-900 shadow-md rounded-lg text-center text-white">
